        ...
        <div className="container mx-auto">
          <div className="max-w-4xl">
            ...
            <p className="mt-4 max-w-2xl text-xl text-white/80">
              Access thousands of items without the burden of ownership. Or make
              money by renting out your belongings.
            </p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-8 text-center">
            ...
            <p className="mt-2 text-lg text-gray-600">
              Find exactly what you need from our wide selection of categories
            </p>
          </div>
      ...
      <section className="bg-gray-50 py-12 md:py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 text-center">
            <Link to="/explore?featured=true" className="btn-primary px-6 py-3">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-3">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="mt-2 text-gray-600">
                Book the items you need for the dates you want and pay securely
                online
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="mt-2 text-gray-600">
                Meet the owner to pickup your rental, enjoy, and return when
                you're done
              </p>
            </div>
          </div>
      ...
      <section className="bg-gray-50 py-12 md:py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-8">
            ...
            <p className="mt-2 text-lg text-gray-600">
              The most rented categories on smartRent
            </p>
          </div>
      ...
      <section className="bg-white py-12 md:py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-8">
            ...
            <p className="mt-2 text-lg text-gray-600">
              Check out the newest items available for rent
            </p>
          </div>
          ...
          <div className="mt-10 text-center">
            <Link to="/explore?sort=newest" className="btn-outline px-6 py-3">
              View All New Items
            </Link>
          </div>
        </div>
      ...
      <section className="bg-gray-50 py-12 md:py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-8 text-center">
            ...
            <p className="mt-2 text-lg text-gray-600">
              Read how smartRent has helped thousands of people
            </p>
          </div>
          ...
          <div className="flex flex-col items-center justify-between rounded-xl bg-white p-8 shadow-lg md:flex-row">
            <div className="mb-6 max-w-2xl md:mb-0">
              ...
              <p className="mt-2 text-lg text-gray-600">
                ...
                earning extra income through smartRent.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-3">
            <div className="rounded-lg border border-gray-200 bg-white p-6 text-center">
              ...
              <p className="mt-2 text-gray-600">
                All transactions are processed securely. We never store your
                payment information.
              </p>
            </div>
            ...
            <div className="rounded-lg border border-gray-200 bg-white p-6 text-center">
              ...
              <p className="mt-2 text-gray-600">
                We verify the identity of all users on our platform to ensure a
                safe community.
              </p>
            </div>
            ...
            <div className="rounded-lg border border-gray-200 bg-white p-6 text-center">
              ...
              <p className="mt-2 text-gray-600">
                Optional insurance coverage to protect both owners and renters
